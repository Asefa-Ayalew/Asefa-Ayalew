...
const NavItem:FunctionComponent<{value:Category | "all",handlerFilterCategory:Function}>= 
...
const ProjectsNavbar:FunctionComponent<{handlerFilterCategory:Function,active}> = (props) => {
  return (
