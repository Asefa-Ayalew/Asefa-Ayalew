...
function Sidebar() {
  return (
    ...
    <div className='py-4 my-5 bg-gray-200' style={{marginLeft:'-1rem', marginRight: '-1rem'}}>
      ...
      <Button className='w-8/12 rounded-f bg-gradient-to-r from green-400 to to-blue-400'>Email me</Button>
      <Button className='w-8/12 rounded-f bg-gradient-to-r from green-400 to to-blue-400'>Toggle theme</Button>
    </div>
    </>
  )
}
