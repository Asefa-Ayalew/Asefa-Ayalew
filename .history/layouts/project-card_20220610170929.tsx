...
const ProjectCard:FunctionComponent<{
  ...
  return (
    ...
    bg-gray-100 dark:bg-dark-100 dark:text-white">
        ...
        <a href={github_url} className="flex items-center px-4 py-2 space-x-3 text-lg bg-gray-200 da">
            <AiFillGithub /><span>Github</span>
        </a>
        <a href={deployed_url} className="flex items-center px-4 py-2 space-x-3 text-lg bg-gray-200 da">
