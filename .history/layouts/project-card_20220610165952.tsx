...
const ProjectCard:FunctionComponent<{
  ...
  return (
    ...
    {
        showDetail && ( 
    <div className="grid md:grid-cols-2 absolute top-0 left-0 z-10 h-auto w-full gap-x-12 text-black bg-gray-100 dark:bg-dark-100 dark:text-white">
        <div>
        ...
        <div>
            ...
            <Button onClick={()=>setShowDetail(false)}><MdClose size={30}/></Button>
    </div>
        )} 
   </div>
  )
