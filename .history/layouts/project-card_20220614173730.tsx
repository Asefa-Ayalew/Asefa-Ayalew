...
const ProjectCard:FunctionComponent<{
  ...
  return (
    ...
    {
        showDetail && ( 
    <div className="absolute top-0 left-0 z-10 grid w-full h-auto py-2 text-black bg-gray-100 md:grid-cols-2 gap-x-12 dark:bg-dark-100 dark:text-white">
        <div>
        ...
        <div>
            ...
            className="absolute p-1 bg-gray-200 rounded-full top-3 right-3 focus:outline-none dark:bg-dark-200"><MdClose size={30}            
            /></Button>
    </div>
        )} 
   </div>
