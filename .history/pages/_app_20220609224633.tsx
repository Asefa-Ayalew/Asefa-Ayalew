...
function MyApp({ Component, pageProps }: AppProps) {
  return (
    ...
    <div className="grid grid-cols-12 gap-6 px-5 my-14 lg:px-48 sm:px-20 md:px-32">
      ...
      <div className="flex flex-col bg-white dark:bg-dark-500 col-span-12 lg:col-span-9 rounded-2xl overflow-hidden shadow-custom-light dark:shadow-custom-dark">
        <Navbar />
        <Component {...pageProps} />
      </div>
    </div>
